...
export default function Indexes() {
  ...
  return (
    <div className=''>
      ...
      <div className={`${!two && "scale-0"} element absolute w-11/12  ml-28 duration-300`}><Notifications root = {root}/></div>
      ...
      <div className={`${!seven && "scale-0"} element absolute w-11/12  ml-28 duration-300`}><Payments root = {root}/></div>
      <div className={`${!eight && "scale-0"} element absolute w-11/12  ml-28 duration-300`}><Userdetails root = {root}/></div>
    </div>
  )
}
/*
