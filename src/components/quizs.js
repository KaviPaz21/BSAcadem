                                    ...
                                    arr.push(
                                        <div className=' bg-blue-100 px-10 py-5 rounded-lg mb-5'>
                                            ...
                                            <div className='grid grid-cols-3'>
                                                ...
                                                <div className='pt-5'>
                                                    <div className='pt-3 font-bold'>QUIZ ID : 1001-1</div>
                                                    <div>Total Questions  : 20</div>
                                                    <div>Time Allowd : 1hr</div>
                                                    <div className='text-red-600'>Status : Not Compleated</div>
                                                </div>

                                                <div >
                                                    <div className='py-2 px-5 bg-blue-600 rounded-lg hover:scale-105 duration-300 w-fit text-white mt-10'>Answer Quiz</div>
                                                </div>
                                            </div>
                                        </div>
                                    )
