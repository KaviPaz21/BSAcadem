...
export default function Helper({ root }) {
    ...
    return (
        <div className='w-c98'>
            <div className='font-csans text-5xl py-6 w-full bg-white shadow-lg shadow-gray-200'>Lia Agent AI</div>
            <div className=' rounded-lg w-full h-c400 mt-5 flex '>
                <div className='w-8/12 h-full bg-zinc-200 rounded-lg  overflow-auto'>
                ...
                <div className='w-4/12 ml-2 h-full bg-zinc-200 rounded-lg'>
                    <div className=' w-full bg-gray-800 text-white pl-12 py-4 text-3xl font-semibold rounded-lg'>Chat Histry</div>
                </div>
