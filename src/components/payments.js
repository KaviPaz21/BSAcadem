...
export default function Payments({root}) {
  return (
    <div>
      <div className='font-csans text-5xl py-5 w-full pl-16 bg-white shadow-lg shadow-gray-200'>Payments & Activations</div>
        <div className=' mt-5 w-full bg-slate-100 rounded-lg flex'>
        <div className='m-3 bg-blue-100 w-1/2 rounded-lg'>
...
<tr>
        ...
        <div className='bg-blue-100 mt-3 rounded-lg w-1/2'>
