...
const Navbar = () => {
    ...
    return (
        ...
        <div className='fixed left-1/2 flex-row -translate-x-1/2 bg-gray-200 px-2 py-2 rounded-xl w-full'>
            <Link to="/Home"><div className={`${active === 1 ? "bg-gray-400" : "bg-gray-200"} hover:scale-105 duration-300 hover:bg-gray-300 px-4 rounded-xl my-2 inline-block py-1`} onClick={() => setindication(1)}><img src={home} alt="home" className=' w-8 ' /></div></Link>
            <Link to="/Profile"><div className={`${active === 2 ? "bg-gray-400" : "bg-gray-200"} hover:scale-105 duration-300 hover:bg-gray-300 px-4 rounded-xl my-2 inline-block py-1`} onClick={() => setindication(2)}><img src={user} alt="home" className=' w-8 ' /></div></Link>
            <Link to="/Lessions"><div className={`${active === 3 ? "bg-gray-400" : "bg-gray-200"} hover:scale-105 duration-300 hover:bg-gray-300 px-4 rounded-xl my-2 inline-block py-1`} onClick={() => setindication(3)}><img src={lession} alt="home" className=' w-8 ' /></div></Link>
            
            <Link to="/Quiz"><div className={`${active === 5 ? "bg-gray-400" : "bg-gray-200"} hover:scale-105 duration-300 hover:bg-gray-300 px-4 rounded-xl my-2 inline-block py-1`} onClick={() => setindication(5)}><img src={quiz} alt="home" className=' w-8 ' /></div></Link>
        </div>
        </div>
    );
};
/*<div>
            <div className=' flex-row justify-center opacity-80'>
                <div className='fixed left-1/2 flex-row -translate-x-1/2 bg-gray-200 ml-2 px-2 py-2 rounded-xl'>
